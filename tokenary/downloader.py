...
def fetch_model_prices_raw(url: str = DEFAULT_PRICE_URL, timeout_seconds: int = 30) -> dict[str, object]:
...
def write_raw_prices_file(raw_prices: dict[str, object], output_path: str | Path) -> Path:
